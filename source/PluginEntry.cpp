/**
    ...
    `CFFGLPluginInfo` that Downlink.cpp registers at static-initialisation
    ...
    binary: which build it is.
        ...
        strings Downlink.bundle/Contents/MacOS/Downlink | grep downlink
*/

extern "C" const char* DownlinkBuildStamp()
{
	return "downlink " DOWNLINK_VERSION " built " __DATE__ " " __TIME__;
}
