/*
 * Stoatworks Labs - About window data for downlink.
 *
 ...
 * — but downlink is not on the website yet, so there is nothing to generate from.
...
namespace stoatworks::about
{
    ...
    inline constexpr auto hook = "Analogue satellite TV, for Resolume";
    ...
    inline constexpr auto repo = "https://github.com/stoatworks-labs/downlink";
